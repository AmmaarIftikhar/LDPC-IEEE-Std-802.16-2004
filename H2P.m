...
% H2P - Convert parity-check matrix H into [I | P] form using Gaussian elimination
% Author: Zhou
%
% Inputs:
...
%
% Outputs:
%   P - Right-side submatrix after conversion
%   rearranged_cols - Column swap history (for reorder_bits)
